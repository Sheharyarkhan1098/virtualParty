  ...
  return (
    <React.Fragment>
      ...
      {isNewEvent && (
        ...
        >
          Use the form below to create your new virtual party. <br />
          As soon as your event has been created, you can share the link
          with your audience.
        </Typography>
      )}
      {/* {isAnonymous && (
          ...
          <form>
            ...
            <div style={{ display: activeStep === 0 ? "block" : "none" }}>
              <TextField
                ...
                required
                helperText={errors.title ? errors.title : "Title of your party"}
                error={errors.title !== undefined}
                disabled={isAnonymous}
              />
              <TextField
                fullWidth
                label="Official party url"
                name="website"
                variant="outlined"
                onChange={handleUpdateField("website")}
                className={classes.textField}
                value={values.website}
                helperText="Add the link to the official party website (if available) or the website of your organisation"
                disabled={isAnonymous}
              />
